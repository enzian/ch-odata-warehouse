...
bq load --quote=\" --source_format=CSV --field_delimiter=";" --ignore_unknown_values --max_bad_records=10 --time_zone="Europe/Zurich" ch_meteo.dwpnt_10min trimmed.csv
...
iconv -f Windows-1252 -t UTF-8 file.csv > file-utf8.csv
cat file-utf8.csv | tail -n +2 | head -n -4 > trimmed.csv
bq load --quote=\" --source_format=CSV --field_delimiter=";" --ignore_unknown_values --max_bad_records=10 --time_zone="Europe/Zurich" ch_meteo.precip_10min trimmed.csv
...
iconv -f Windows-1252 -t UTF-8 file.csv > file-utf8.csv
cat file-utf8.csv | tail -n +2 | head -n -4 > trimmed.csv
bq load --quote=\" --source_format=CSV --field_delimiter=";" --ignore_unknown_values --max_bad_records=10 --time_zone="Europe/Zurich" ch_meteo.radiation_10min trimmed.csv
...
iconv -f Windows-1252 -t UTF-8 file.csv > file-utf8.csv
cat file-utf8.csv | tail -n +2 | head -n -4 > trimmed.csv
bq load --quote=\" --source_format=CSV --field_delimiter=";" --ignore_unknown_values --max_bad_records=10 --time_zone="Europe/Zurich" ch_meteo.rh_10min trimmed.csv
...
iconv -f Windows-1252 -t UTF-8 file.csv > file-utf8.csv
cat file-utf8.csv | tail -n +2 | head -n -4 > trimmed.csv
bq load --quote=\" --source_format=CSV --field_delimiter=";" --ignore_unknown_values --max_bad_records=10 --time_zone="Europe/Zurich" ch_meteo.sunshine_10min trimmed.csv
...
iconv -f Windows-1252 -t UTF-8 file.csv > file-utf8.csv
cat file-utf8.csv | tail -n +2 | head -n -4 > trimmed.csv
bq load --quote=\" --source_format=CSV --field_delimiter=";" --ignore_unknown_values --max_bad_records=10 --time_zone="Europe/Zurich" ch_meteo.temp_2m_10min trimmed.csv
...
iconv -f Windows-1252 -t UTF-8 file.csv > file-utf8.csv
cat file-utf8.csv | tail -n +2 | head -n -4 > trimmed.csv
bq load --quote=\" --source_format=CSV --field_delimiter=";" --ignore_unknown_values --max_bad_records=10 --time_zone="Europe/Zurich" ch_meteo.wind_10min trimmed.csv
